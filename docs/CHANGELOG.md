...
### Changed
- warm taxonomy inventories after invalidation
...
### Fixed
- keep event date status synchronized
...
### Fixed
- bound duplicate candidate date queries
...
### Fixed
- clamp ongoing event boundaries
...
### Added
- add datamachine_get_event_timing() core primitive
