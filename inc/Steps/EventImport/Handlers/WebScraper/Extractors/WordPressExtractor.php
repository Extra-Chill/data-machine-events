...
class WordPressExtractor extends BaseExtractor {
	...
	private const SKIP_DOMAINS = array(
		'resoundpresents.com',
	);
	...
	private function extractTribeOrganizer( array $event ): array {
		$organizer = $event['organizer'] ?? array();
	...
	private function mapGenericEvent( array $event, string $source_url ): array {
		...
		$date_fields = array( 'start_date', 'event_date', 'date', 'startDate' );
		...
		$end_date_fields = array( 'end_date', 'endDate' );
