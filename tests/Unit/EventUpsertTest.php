...
class EventUpsertTest extends EventUpsertTestCase {
	...
	// Fallback (source-identity-miss) duplicate-collapse coverage lives in
	// EventUpsertFallbackDedupeTest to keep this file under the structural
	// line-count threshold; both extend EventUpsertTestCase for shared setup.
